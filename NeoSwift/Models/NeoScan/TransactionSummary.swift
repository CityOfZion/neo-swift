...
@objc public class TransactionHistory: NSObject, Codable {
    ...
    @objc public var entries: [TransactionSummary]
    ...
    public init(total_pages: Int, total_entries: Int, page_size: Int,
                page_number: Int, entries: [TransactionSummary]) {
    ...
    public required convenience init(from decoder: Decoder) throws {
        ...
        let entries: [TransactionSummary] = try container.decode([TransactionSummary].self, forKey: .entries)
...
@objc public class TransactionSummary: NSObject, Codable {
