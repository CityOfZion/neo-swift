...
@objc public class NeoScan: NSObject {
    ...
    @objc public func getTransactionHistory(address1: String, address2: String, page: Int, completion: @escaping(NEOScanTransactionHistory?, NeoClientError?) -> Void) {
    ...
    private func doDeserializeToTransactionHistory(jsonResult: JSONDictionary?, error: NeoClientError?, completion: @escaping(NEOScanTransactionHistory?, NeoClientError?) -> Void) {
